...
export default function SvgMap({ provinces, mapData, mapTitle }: SvgMapProps) {
  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute top-4 left-4 bg-black/40 backdrop-blur-md border border-white/10 rounded-lg px-3 py-2 text-xs text-muted-foreground pointer-events-none">
